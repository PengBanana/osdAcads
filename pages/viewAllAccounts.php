                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper" >
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
									<tr class="odd gradeX"><td class="text-center" ><form action="athleteProfile" method="post"><input type="hidden" value="'.$idnumber.'"><input type="button" value="'.$fullname.'"></form></td><td class="text-center">
									<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModalDecline">Deactivate</button></td></tr>
                                ...
                                <!-- Modal Decline-->
                                <div class="modal fade" id="myModalDecline" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
												...
												<input type="submit" class="btn btn-warning" name="rejectAccount" value="confirm">
												</form>
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
