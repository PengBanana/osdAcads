      ...
      <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0" id="up">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
				...
				JOIN plannedenrollmentchart pec ON sd.PlannedEnrollmentChart_pecID=pec.pecID WHERE sd.finalGrade IS NULL OR sd.finalGrade=0 AND studentIDNumber="'.$athleteID.'";';
				$result=mysqli_query($dbc,$query);
				$row=mysqli_fetch_array($result,MYSQLI_ASSOC);
				$units=$row['rem'];
				if(empty($units)){
