    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Year', 'Dean Liststers', 'Regular Athletes', 'Critical Athletes', 'Suspended Athletes'],
          ['Term 1', 200, 200, 190, 10],
          ['Term 2', 150, 250, 190, 10],
          ['Term 3', 200, 200, 170, 30]
        ]);
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
			...
			<div class="row">
			<div class="col-lg-12">
			<label>History of Dean Listers</label>
			</div>
			</div>
			<div class="row">
			<div class="col-lg-12">
                ...
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div>
							<div id="barchart_material" style="width: 650px; height: 400px;"></div>
